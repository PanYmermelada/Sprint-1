 ...
 */
public class GUIpruebasVerificador extends JFrame implements ActionListener {
    ...
    public static void main(String[] args){
        GUIpruebasVerificador v=new GUIpruebasVerificador();
        v.setVisible(true);
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try {
            ...
            Logger.getLogger(GUIpruebasVerificador.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}
